...
//
import { PRIMARY_NAVIGATION_LINKS, PROFILE_DROPDOWN_LINKS } from 'apps/next-starter/util/routes/nav';
...
<div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="pt-4 pb-3 border-t border-gray-200 border-opacity-25">
                <div className="flex items-center px-5">
                    ...
                    <div className="ml-3">
                        <div className="text-base font-medium text-gray-200">Tom Cook</div>
                        <div className="text-sm font-medium text-gray-200">tom@example.com</div>
                    </div>
